...
import { Globe2, MapPin, Store } from "lucide-react";
    ...
    <span
      className={cn(
        ...
        global
          ...
          : isStore
            ? "bg-emerald-500/10 text-emerald-800 ring-1 ring-emerald-500/20 dark:bg-emerald-500/15 dark:text-emerald-300"
