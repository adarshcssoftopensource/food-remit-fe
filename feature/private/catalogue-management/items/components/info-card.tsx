...
export function InfoCard({ icon, label, value }: InfoCardProps) {
  return (
    <div className="group hover:border-primary/20 hover:shadow-primary/5 relative flex h-full items-center gap-3 rounded-xl border border-slate-100 bg-slate-50/50 px-4 py-3 transition-colors transition-shadow transition-transform duration-200 hover:-translate-y-0.5 hover:bg-white hover:shadow-lg dark:border-slate-800/80 dark:bg-slate-900/30 dark:hover:bg-slate-900">
