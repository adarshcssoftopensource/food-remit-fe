  ...
  return (
    <div className="grid gap-4 lg:grid-cols-2">
      ...
      {(item.productInfo || item.productInfoImageUrl) && (
        <Card className="rounded-2xl border-0 bg-gradient-to-br from-blue-50 to-white shadow-lg shadow-blue-100/50 dark:from-slate-900 dark:to-slate-950 dark:shadow-none">
