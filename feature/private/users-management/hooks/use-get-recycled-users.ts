...
export function useGetRecycledUsers(args: UseGetUsersArgs = {}) {
  const url = buildUrl(USER_MANAGEMENT_ENDPOINTS.GET_RECYCLED_USERS, {
    ...args,
    sortOrder: args.sortOrder ?? "asc",
  });
  const cacheKey = buildCacheKey("RECYCLED_USERS", {
    ...args,
    sortOrder: args.sortOrder ?? "asc",
  });
